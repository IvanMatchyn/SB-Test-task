...
import { TStorageValue } from '../models/types/storage.types.ts';
...
const getStorageStringData = (key: string, secure?: boolean) => selectStorage(secure).getString(key);

const getStorageNumberData = (key: string, secure?: boolean) => selectStorage(secure).getNumber(key);

const getStorageBooleanData = (key: string, secure?: boolean) => selectStorage(secure).getBoolean(key);
